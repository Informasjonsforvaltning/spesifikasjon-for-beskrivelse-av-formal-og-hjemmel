...
For at det følgende skal virke på din maskin, må du ha programvare installert:  
 ...
 Dersom du bruker Atom kan du gjøre som følger:  
  ...
  - I Clone from legger du inn følgende url `https://github.com/Informasjonsforvaltning/spesifikasjon-for-beskrivelse-av-formal-og-hjemmel.git`

Alternativt i kommando-linje:
```
% git clone https://github.com/Informasjonsforvaltning/spesifikasjon-for-beskrivelse-av-formal-og-hjemmel.git
% cd spesifikasjon-for-beskrivelse-av-formal-og-hjemmel
...
Gå til https://github.com/Informasjonsforvaltning/spesifikasjon-for-beskrivelse-av-formal-og-hjemmel/pulls og opprett `New pull request`
